...
| 9 | Agreements and customer actions | Step 9A implemented / awaiting review: versioned immutable agreement snapshots, OTP customer-action pages, verified business membership reuse, Admin-verified Manager access, and a narrow `apps/customer` action app. Step 9B pending (customer evidence upload and approved-pack viewing). Do not claim Step 9 complete. See customer-actions.md |
