...
describe("resource registry", () => {
  it("exposes only publish-ready resources", () => {
    ...
    expect(resourceRegistry).toHaveLength(20)
    ...
    expect(publishedSlugs).toHaveLength(20)
  ...
  it("only publishes resources on the approved allowlist", () => {
    expect(approvedPublishedResourceSlugs).toHaveLength(20)
  ...
  it("stays valid now that every planned resource is published", () => {
    ...
    expect(getPublishedResources()).toHaveLength(20)
