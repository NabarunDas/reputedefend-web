export const actions = { SIGNED_IN: "Signed in", SIGNED_OUT: "Signed out", SIGNED_OUT_ALL: "Signed out all devices", SESSION_REVOKED: "End another session" } as const
export const outcomes = { success: "Completed", denied: "Not allowed", conflict: "Session no longer available", reauth_required: "New sign-in needed" } as const
export type Activity = { id: string; createdAt: string; action: keyof typeof actions; outcome: keyof typeof outcomes; targetId: string | null; requestId: string }
