...
| 8 | Evidence storage and review | Step 8A complete. Step 8B complete and live acceptance confirmed on 18 September 2026 (profilerelaunch-dev: upload → S3 → GuardDuty → refresh → View/Download → review). Step 8C implemented / awaiting review: prepared packs as immutable metadata manifests, evidence begin-upload immutability after finalisation. Do not mark all of Step 8 complete until 8C is reviewed, merged, migrated and live accepted. See evidence-storage.md |
