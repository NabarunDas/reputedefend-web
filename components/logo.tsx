...
export function ReputeLogo({ variant = "dark", markOnly = false, className, ...props }: LogoProps) {
  ...
  return (
    <svg viewBox="0 0 280 64" role="img" aria-label="ReputeDefend" className={className} {...props}>
      <g transform="translate(0 0)"><ReputeMark variant={variant} width="64" height="64" /></g>
      <text x="76" y="42" fill={palette.text} fontFamily="Arial, sans-serif" fontSize="27" fontWeight="700" letterSpacing="-1.8">Repute<tspan fill={palette.accent}>Defend</tspan></text>
    </svg>
  )
}
