export const actions = { SIGNED_IN: "Signed in", SIGNED_OUT: "Signed out", SIGNED_OUT_ALL: "Signed out all devices", SESSION_REVOKED: "End another session", RECORD_CREATED: "Record created", RECORD_UPDATED: "Record updated", CONTACT_VERIFIED: "Contact verified", MEMBERSHIP_CHANGED: "Business relationship changed" } as const
