...
| Step 8C additive migration not applied remotely | `20260918155409_admin_prepared_packs_v1.sql` is in source only. Filename order is now 8A → 8B → 8C. | Apply once to the intended Supabase project after review. Do not replay 8A/8B. Do not enable PREPARATION/READY_TO_SUBMIT from this pack alone. |
