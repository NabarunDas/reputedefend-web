...
| [0002](0002-presigned-s3-read-urls.md) | Short-lived direct S3 presigned GET URLs for Admin evidence preview/download instead of proxying bytes through Vercel | Accepted |
