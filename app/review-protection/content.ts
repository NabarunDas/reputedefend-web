...
export const situations = [
  ...
  },
  {
    ...
    body: "Names, locations or services in the review may point to a different business, which changes how you should respond.",
  },
  {
...
export const expertisePrinciples = [
  {
    title: "Separate facts from suspicion",
    body: "Record what you can actually establish before deciding what to allege, report or say publicly.",
  },
  {
    title: "Keep public replies professional",
    body: "Respond for the customers reading the exchange as much as for the reviewer themselves.",
  },
  {
    title: "Preserve the record",
    body: "Keep the review link, wording, date, relevant messages and useful context before the situation changes.",
  },
]
...
export const evidenceItems = [
  "Direct review link",
  "Review date and exact wording",
  "Short timeline of relevant events",
  "Relevant business records",
  "Relevant communications where lawful and appropriate",
  "Screenshots or similar-review details",
  "Anything already reported to Google and any response",
]

export const processSteps = [
  {
    title: "Share the concern",
    body: "Send the review link, what concerns you and any relevant context. You don't need to identify the policy issue yourself.",
  },
  {
    title: "We assess the situation",
    body: "We review the content, context and available evidence and identify what needs clarification.",
  },
  {
    title: "Choose the next route",
    body: "We explain whether responding, reporting or challenging, documenting or another step appears to fit the situation.",
  },
]
...
export const reviewFaqs = [
  ...
  },
  {
    ...
    a: "Reviews that appear unrelated to a genuine experience, may concern the wrong business, include threats, harassment or sensitive information, or arrive as an unusual cluster may be worth a closer look. The content, surrounding facts and available records matter more than the rating alone.",
  },
  {
    q: "What if I believe the reviewer was never a customer?",
    a: "An unfamiliar name or missing customer record does not automatically prove that a review is false. A reviewer may use a different name, describe an interaction that did not become a sale, or refer to something that is not immediately identifiable. Share what you have checked and what remains unknown.",
  },
  {
    q: "What should I do if several suspicious reviews appear together?",
  ...
  },
  {
    ...
    a: "A professional public response, documenting what happened, or watching for new information may still be useful. Repeating the same unsupported report is rarely the strongest next step. We can help you interpret the outcome and decide whether another route is actually supported.",
  },
]
