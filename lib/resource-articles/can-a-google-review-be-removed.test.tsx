...
describe("Article #5 can a Google review be removed", () => {
  ...
  it("is publish-ready with approved metadata and sources", () => {
    ...
    expect(getPublishedResourceBySlug("fake-google-review-or-genuine-negative-feedback")).toBeUndefined()
  ...
  it("renders approved copy, hides draft related guides, and uses the Review Protection CTA", () => {
    ...
    expect(
      screen.queryByText("Fake Google Review or Genuine Negative Feedback? How to Tell the Difference"),
